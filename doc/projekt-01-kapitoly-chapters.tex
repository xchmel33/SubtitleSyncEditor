...
\begin{itemize}
    ...
    \item Focus on simultaneous editing of multiple files distinguishes it.
\end{itemize}

\subsection{Subtitle Workshop}
\href{https://subworkshop.sourceforge.net/news.php#1}{https://subworkshop.sourceforge.net/news.php#1}
\begin{itemize}
    \item Simple to install on Windows, Linux and Os X
...
\subsection{GUI}
\begin{itemize}
  \item PyQt - requires a commercial license for commercial applications
  \item PySide6 - Qt for Python (Qt 6), commercial license
  \item Tkinter - Python's de-facto standard GUI (comes with Python), open source
  \item Kivy - open source, cross-platform GUI, mobile support
\end{itemize}
