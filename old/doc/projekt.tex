...
\projectinfo{
  ...
  keywords.cs={
  úprava titulkov, synchronizácia viacerých súborov, konverzia formátu titulkov, automatická kontrola pravopisu, analýza zvukového priebehu, Qt, signály, vývoj naprieč platformami
  }, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={
  subtitle editing, multi-file synchronization, subtitle format conversion, automated spell checking, waveform, Qt, signal, cross-platform development
